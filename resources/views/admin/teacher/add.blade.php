                ...
                <div class="card-body">
                    ...
                    <form action="{{route('teacher.new')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control text-capitalize" name="name" id="horizontal-firstname-input">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="designation" id="horizontal-password-input">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <textarea name="address" id="horizontal-password-input2" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
